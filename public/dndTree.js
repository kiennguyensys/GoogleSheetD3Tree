...
treeJSON = d3.json("nodes.json", function(error, treeData) {
    ...
    var nodeinfo = [{"cx": 20, "cy": 20, "name": "Name"},
                    {"cx": 20, "cy": 40, "name": "Type"},
										{"cx": 20, "cy": 60, "name": "Person"},
								    {"cx": 20, "cy": 80, "name": "Condition"}
                    ];
    ...
    //current node info and svg text
    ...
    var baseSvg = d3.select("#tree-container").append("svg")
        ...
        .attr("class", "overlay")
        .call(zoomListener);
    var textSvg = baseSvg.append('svg').attr("width", 800).attr("height", 400);
...
//      bar1data = [[0,0],[0,0],[0,0]];
    ...
    function updateinfo(info){
      var newnodeinfo = [{"cx": 20, "cy": 20, "name": info.name},
                  {"cx": 20, "cy": 40, "name": info.person.type},
									{"cx": 20, "cy": 60, "name": info.person.mail},
						      {"cx": 20, "cy": 80, "name": info.person.condition}
                  ];
      ...
      //texts.exit().remove();
                  ...
                  var texts = textSvg.selectAll("text").data(newnodeinfo).enter()
                        .append("text").attr("x", function(d) { return d.cx; })
                                        .attr("y", function(d) { return d.cy; })
                                        .text( function (d) { return " " + d.name +" "; })
                                        .attr("font-family", "sans-serif")
                                        .attr("font-size", "15px")
